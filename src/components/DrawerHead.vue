<template>
    <div class="drawer-main__header">
        <svg class="opacity-50 cursor-pointer rotate-180 hover:opacity-100 transition hover:-translate-x-0.5"
        ...
        <h2 class="drawer-main__title">Корзина</h2>
    </div>
</template>
